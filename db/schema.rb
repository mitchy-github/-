...
ActiveRecord::Schema.define(version: 2022_08_19_074005) do
  ...
  create_table "reservations", force: :cascade do |t|
    ...
    t.bigint "reservation_price"
    t.date "reservation2_start"
    t.date "reservation2_end"
    t.bigint "reservation2_people"
